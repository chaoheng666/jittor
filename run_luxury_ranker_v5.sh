...
# Dynamic-graph heavy: wider CRAFT sweep plus moderate neural residuals.
export ZIP_PATH="${ZIP_PATH:-result_v5_craft.zip}"
export VALID_ROOT="${VALID_ROOT:-validation_v5_craft}"
export MODEL_ROOT="${MODEL_ROOT:-competition_models_v5_craft}"
export SCORE_DIR="${SCORE_DIR:-competition_scores_v5_craft}"
export OUT_DIR="${OUT_DIR:-submission_v5_craft}"
...
export SEQ_LENS="${SEQ_LENS:-50,100}"
...
export CRAFT_NEIGHBORS="${CRAFT_NEIGHBORS:-20,30,50,80}"
...
export CRAFT_BATCH_SIZE="${CRAFT_BATCH_SIZE:-140}"
